const bankTemplate = require("../templates/bank-markup.hbs");
const debitTemplate = require("../templates/debit-markup.hbs");
const creditTemplate = require("../templates/credit-markup.hbs");
